...
function questionnaire_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of questionnaire_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ6RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ6Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ7RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ7Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ8RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ8Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ9RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ9Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ10RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ10Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ11RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ11Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ12RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ12Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ13RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ13Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ14RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ14Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ15RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ15Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PSWQ16RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PSWQ16Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function q2_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of q2_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AM1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AM1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AM2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AM2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AM3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AM3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AM4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AM4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AM5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AM5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function q3_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of q3_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ5RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ5Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ6RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ6Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ7RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ7Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ8RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ8Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ9RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ9Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ10RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ10Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SQP11RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SQP11Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ12RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ12Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ13RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ13Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ14RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ14Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ15RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ15Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ16RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ16Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ17RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ17Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ18RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ18Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ19RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ19Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ20RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ20Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ21RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ21Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SPQ22RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of SPQ22Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function q4_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of q4_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function learning_phaseLoopBegin(learning_phaseLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLearning_phase of learning_phase) {
...
function learn_1LoopBegin(learn_1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLearn_1 of learn_1) {
...
function incorrect_loopLoopBegin(incorrect_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisIncorrect_loop of incorrect_loop) {
...
function quiz_loop1LoopBegin(quiz_loop1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisQuiz_loop1 of quiz_loop1) {
...
function learn_1_2LoopBegin(learn_1_2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLearn_1_2 of learn_1_2) {
...
function incorrect_loop2LoopBegin(incorrect_loop2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisIncorrect_loop2 of incorrect_loop2) {
...
function quizloop2LoopBegin(quizloop2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisQuizloop2 of quizloop2) {
...
function planning_during_trainingLoopBegin(planning_during_trainingLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPlanning_during_training of planning_during_training) {
...
function instructions_planning_get_rightLoopBegin(instructions_planning_get_rightLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisInstructions_planning_get_right of instructions_planning_get_right) {
...
function planning_loopLoopBegin(planning_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPlanning_loop of planning_loop) {
...
function remember_planning_pathsLoopBegin(remember_planning_pathsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisRemember_planning_path of remember_planning_paths) {
...
function second_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of second_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function third_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of third_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice1_resultRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice1_resultComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function next_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of next_trialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice1_quizRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice1_quizComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice1_quizfeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice1_quizfeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function memory_quiz_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of memory_quiz_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz1_iRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz1_iComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz2_iRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz2_iComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function start_learningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_learningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function learn1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of learn1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function check_incorrect1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of check_incorrect1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function learn2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of learn2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function counter_quizzes_roundRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of counter_quizzes_roundComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function back_to_learnRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of back_to_learnComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function check_incorrectRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of check_incorrectComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function planning_pathsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of planning_pathsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function forgetting_paths1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of forgetting_paths1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function planningpathstraining2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of planningpathstraining2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function correct_forget_pathsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of correct_forget_pathsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function total_score_planningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of total_score_planningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function break_routineRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of break_routineComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_rewardRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_rewardComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_planning_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_planning_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_example_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_example_trialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function long_term_reward_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of long_term_reward_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz_planning_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz_planning_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz_planning_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz_planning_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function quiz_planning_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of quiz_planning_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function see_planning_trialsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of see_planning_trialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_planning_newRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_planning_newComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function planning_2_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of planning_2_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instructions_planning_new3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_planning_new3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice_planning_outcomesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice_planning_outcomesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function immediate_rewar_lessonRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of immediate_rewar_lessonComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function lesson_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of lesson_practiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function lesson_practice_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of lesson_practice_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function start_real_planningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_real_planningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function plan1_info_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of plan1_info_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function plan2_infoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of plan2_infoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function plan3_infoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of plan3_infoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function planning4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of planning4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
