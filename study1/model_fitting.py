...
name_X = 'MBMC_Breadth2_Depth_CCRF_CB_PE2'
group_parameters_info_8 = {
    'MB_B':         ['gamma', [1, 1]],
    'MB_depth':     ['beta',  [1, 1]],
    'MB_breadth':   ['beta',  [1, 1]],
...
build_model(name_X, likelihood, group_parameters_info_8,
            number_subjects, parameter_sample_size)
all_models.append(MBMC_Breadth2_Depth_CCRF_CB_PE2)
...
models_BICs_record={'MBMC_optimal': np.float64(15596.645196764157), 'MBMC_Depth': np.float64(14670.133972663647),
  'MBMC_Breadth2': np.float64(10307.45377277681), 'MBMC_Breadth1': np.float64(14417.971214461892),
    'MBMC_Breadth2_Depth': np.float64(9286.742588004185), 
	'MBMC_Breadth2_Depth_CC': np.float64(7852.682887150853),
	  'MBMC_Breadth2_Depth_CCR': np.float64(7655.391906313971), 
	  'MBMC_Breadth2_Depth_CCRF': np.float64(6962.630769868358),
	    'MBMC_Breadth2_Depth_CCRF_CB': np.float64(6800.837789734708), 
		'MBMC_Breadth2_Depth_CCRF_CB_PE': np.float64(6600.496281299736),
		  'MBMCF_Breadth2_Depth_CCRF_CB': np.float64(6836.458578342278),
		    'MBMCreplace_Breadth2_Depth_CCRF_CB_PE': np.float64(6621.958213094107),
			  'MBMCsequential_Breadth2_Depth_CCRF_CB': np.float64(6817.015594433069), 
			  'MBMC_Breadth2_Depth_CB_MF': np.float64(7101.666268616842), 
			  'MBMC_Breadth2_Depth_MF': np.float64(7351.0486761619095)}
...
d = pd.DataFrame()
current_results=models_Results_record['MBMC_Breadth2_Depth_CCRF_CB_PE2'] # winning model
counter=2
